...
<head>
    ...
    <title>Browse Pets - FurNest</title>
    <link rel="stylesheet" href="styles.css">
    <link rel="stylesheet" href="browse-pets-styles.css">
    <link rel="icon" type="icon/x-icon" href="resources/logo.jpeg">
    <style>
        *::selection {
    ...
    <main style="background-color: rgb(251, 245, 235);">
        <section class="browse-pets">
            <section class="heroo">
                <div class="hero-container">
                    ...
                    <div class="hero-buttons">
                        ...
                        <a href="#birds"><button>Birds</button></a>
                    </div>
                </div>
            </section>
            ...
            <div class="pet-listings">
                ...
                <div class="pet-grid">
                    <div class="pet-card">
                        <img src="resources/1.webp" alt="Bird 1">
                        <h3>Am Yellow</h3>
                        <p>Age: 6 Months</p>
                        <p>Breed: Forous</p>
                        <p>Gender: Male</p>
                    ...
                    <div class="pet-card">
                        <img src="resources/2.jpg" alt="Bird 2">
                        <h3>TCB</h3>
                        <p>Age: 7 Months</p>
                        <p>Breed: Japanese Budgriger</p>
                        <p>Gender: Male</p>
                        <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                    </div>

                     <div class="pet-card">
                        <img src="resources/3.webp" alt="Bird 3">
                        <h3>TCB</h3>
                        <p>Age: 6 Months</p>
                        <p>Breed: Finch</p>
                        <p>Gender: Female</p>
                  ...
                  <div class="pet-grid">
                    <div class="pet-card">
                        <img src="resources/5.jpg" alt="Bird 4">
                        <h3>Black Face Hogoromp</h3>
                        <p>Age: 1 year</p>
                        <p>Breed: Japanese Budgriger</p>
                        <p>Gender: Male</p>
                        <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                    ...
                    <div class="pet-card">
                        <img src="resources/6.jpg" alt="Bird 5">
                        <h3>English</h3>
                        <p>Age: 2 years</p>
                        <p>Breed: Japanese Budgriger</p>
                        <p>Gender: Female</p>
                    ...
                    <div class="pet-card">
                        <img src="resources/8.webp" alt="Bird 6">
                        <h3>Red Factor</h3>
                        <p>Age: 1.5 year</p>
                        <p>Breed: Canary</p>
                        <p>Gender: Female</p>
