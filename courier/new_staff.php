          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <input type="text" name="firstname" id="" class="form-control form-control-sm" id="event" onkeydown="return alphaOnly(event); " value="<?php echo isset($firstname) ? $firstname : '' ?>" required>
              </div>
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Last Name</label>
                <input type="text" name="lastname" id="" class="form-control form-control-sm" id="event" onkeydown="return alphaOnly(event); "value="<?php echo isset($lastname) ? $lastname : '' ?>" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                ...
                <input type="email" name="email" id="" class="form-control form-control-sm" pattern="[a-z][0-9a-z._%+-]+@fcms.com"value="<?php echo isset($email) ? $email : '' ?>" required>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6 form-group ">
